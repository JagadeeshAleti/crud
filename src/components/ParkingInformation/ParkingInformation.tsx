...
const ParkingInformation: React.VoidFunctionComponent<IParkingInformationProps> = ({ uxpContext }) => {
    ...
    const [zoomLevel, setZoomLevel] = React.useState<number>(19);
    const [centerOfMap, setCenterOfMap] = React.useState<LatLngExpression>([24.519010249785516, 39.56975519657136]);
    ...
    return (
        <div style={{ position: 'relative' }}>
            <div className="map-control-edit-button-container">
                ...
                {/* Here we've taken 'book parking spot' button isn't belongs to top panel. Occasional change, Sorry...  */}
                <Conditional
